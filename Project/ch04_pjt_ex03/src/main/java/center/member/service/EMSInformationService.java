...
import center.member.model.DBConnectionInfoVO;
...
public class EMSInformationService {
	...
	private Map<String, DBConnectionInfoVO> dbInfos;
	...
	private void printDBInfo() {
		...
		while (iterator.hasNext()) {
			...
			DBConnectionInfoVO info = dbInfos.get(key);
	...
	public Map<String, DBConnectionInfoVO> getDbInfos() {
		return dbInfos;
	}

	public void setDbInfos(Map<String, DBConnectionInfoVO> dbInfos) {
